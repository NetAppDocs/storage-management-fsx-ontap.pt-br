...
link:https://review.docs.netapp.com/us-en/workload-fsx-ontap_wa-updates/change-tiering-policy.html["Modificar a política de tiering"] para o(s) volume(s) alvo após a transição.
